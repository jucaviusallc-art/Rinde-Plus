...
export const HomeScreen: React.FC<HomeScreenProps> = ({
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-1.5 py-0">

      {/* =====================================================
          HERO COMPACTO
      ====================================================== */}

      <div className="bg-linear-to-br from-[#2E7D32]/10 via-emerald-50 to-white dark:from-emerald-950/40 dark:via-slate-900 dark:to-slate-900 border border-emerald-200/80 dark:border-slate-800 rounded-xl p-2.5 sm:p-3 shadow-xs">

        <div className="flex items-center gap-2 mb-0.5">

          <div className="p-1 bg-[#2E7D32] text-white rounded-lg shadow-xs">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-3 sm:p-3.5 shadow-xs space-y-2">
        ...
        <h2 className="text-xs sm:text-sm font-bold text-slate-900 dark:text-white flex items-center gap-1.5">
          <Settings2 className="w-3.5 h-3.5 text-[#2E7D32]" />
        ...
        {errorMsg && (
          <div className="p-2 bg-rose-50 dark:bg-rose-950/50 border border-rose-200 dark:border-rose-800 text-rose-700 dark:text-rose-300 rounded-lg text-xs flex items-center gap-2">
        ...
        >
          ...
          <div>
            ...
            <label className="block text-[10px] sm:text-[11px] font-semibold text-slate-700 dark:text-slate-300 mb-0.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-3 py-1.5 bg-slate-50 dark:bg-slate-800/90 border border-slate-300 dark:border-slate-700 rounded-lg font-bold text-base sm:text-lg text-slate-900 dark:text-white focus:ring-2 focus:ring-[#2E7D32] focus:border-transparent outline-none transition-all"
              />
          ...
          <div className="space-y-1">
            ...
            <label className="block text-[10px] sm:text-[11px] font-semibold text-slate-700 dark:text-slate-300">
            ...
            <div className="grid grid-cols-2 gap-1 p-0.5 bg-slate-100 dark:bg-slate-800 rounded-lg">
              ...
              >
                ...
                <Euro className="inline-block w-3 h-3 mr-1" />
          ...
          <div className="space-y-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5">
              ...
              >
                ...
                <div className="mt-0.5 text-xs sm:text-sm font-black text-[#2E7D32] dark:text-emerald-400 flex items-center justify-between">
          ...
          {tipoTasa === "custom" && (
            <div className="p-2 bg-amber-50/70 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800/60 rounded-xl space-y-1 animate-fadeIn">

              <label className="block text-[10px] sm:text-[11px] font-semibold text-amber-900 dark:text-amber-200">
              ...
              <div className="relative">
                ...
                <span className="absolute left-2.5 top-1/2 -translate-y-1/2 text-amber-700 dark:text-amber-400 font-bold text-xs">
                  Bs/{currencyLabel}
                </span>
                ...
                <input
                  ...
                  className="w-full pl-15 pr-3 py-1 bg-white dark:bg-slate-800 border border-amber-300 dark:border-amber-700 rounded-lg font-bold text-xs text-slate-900 dark:text-white focus:ring-2 focus:ring-[#2E7D32] outline-none"
                />
          ...
          <div className="p-2.5 bg-slate-900 text-white rounded-xl flex items-center justify-between shadow-xs">
            ...
            <div>
              ...
              <div className="text-lg sm:text-xl font-black text-emerald-400 mt-0.5 flex items-center gap-1">

                {monedaSeleccionada === "EUR" ? (
                  <Euro className="w-4 h-4 shrink-0 text-emerald-400" />
                ) : (
          ...
          <button
            ...
            className="w-full py-2 bg-[#2E7D32] hover:bg-emerald-800 text-white font-bold text-sm sm:text-base rounded-xl shadow-md shadow-emerald-900/20 flex items-center justify-center gap-2 transition-all hover:scale-[1.01] active:scale-[0.99] disabled:opacity-50 disabled:cursor-not-allowed"
          >
