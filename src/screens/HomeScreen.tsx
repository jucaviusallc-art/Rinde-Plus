...
export const HomeScreen: React.FC<HomeScreenProps> = ({
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-2 py-1">
      ...
      {/* =====================================================
          HERO (Ajustado en altura interna para evitar scroll)
      ====================================================== */}

      <div className="bg-linear-to-br from-[#2E7D32]/10 via-emerald-50 to-white dark:from-emerald-950/40 dark:via-slate-900 dark:to-slate-900 border border-emerald-200/80 dark:border-slate-800 rounded-2xl p-2.5 sm:p-3 shadow-xs">
      ...
      {/* =====================================================
          FORMULARIO PRINCIPAL (Tamaño original restaurado)
      ====================================================== */}
